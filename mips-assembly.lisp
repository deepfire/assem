...
(defmipsinsn :tlbr    nil ((#b010000 25 #x1) (#b1 0 #x3f) (#b000001 0 0)) :empty)
(defmipsinsn :tlbwi   nil ((#b010000 25 #x1) (#b1 0 #x3f) (#b000010 0 0)) :empty)
(defmipsinsn :tlbwr   nil ((#b010000 25 #x1) (#b1 0 #x3f) (#b000110 0 0)) :empty)
(defmipsinsn :tlbp    nil ((#b010000 25 #x1) (#b1 0 #x3f) (#b001000 0 0)) :empty)
(defmipsinsn :eret    (:ex)  ((#b010000 25 #x1) (#b1 0 #x3f) (#b011000 0 0)) :empty)
(defmipsinsn :deret   (:ex)  ((#b010000 25 #x1) (#b1 0 #x3f) (#b011111 0 0)) :empty)
