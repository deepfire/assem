...
(defmipsinsn :j       (:ri im1bd26) ((#b000010 0 0)) :im26)
(defmipsinsn :jal     (:ri im1bd26) ((#b000011 0 0)) :im26)
...
(defmipsinsn :beq     (:cri im3bd16) ((#b000100 0 0)) :testgpr-basegpr-im16off)
(defmipsinsn :bne     (:cri im3bd16) ((#b000101 0 0)) :testgpr-basegpr-im16off)
(defmipsinsn :blez    (:cri im3bd16) ((#b000110 0 0)) :testgpr-basegpr-im16off)
(defmipsinsn :bgtz    (:cri im3bd16) ((#b000111 0 0)) :testgpr-basegpr-im16off)
...
(defmipsinsn :bc0f    (:cri im1bd16) ((#b010000 21 #x1) (#x8 16 #x1f) (#b0000 0 0)) :im16)
(defmipsinsn :bc0t    (:cri im1bd16) ((#b010000 21 #x1) (#x8 16 #x1f) (#b0001 0 0)) :im16)
(defmipsinsn :bc0f1   (:cri im1bd16) ((#b010000 21 #x1) (#x8 16 #x1f) (#b0010 0 0)) :im16)
(defmipsinsn :bc0t1   (:cri im1bd16) ((#b010000 21 #x1) (#x8 16 #x1f) (#b0011 0 0)) :im16)
...
(defmipsinsn :bc1f    (:cri im2bd16) ((#b010001 21 #x1f) (#b01000 16 #x3) (#b00 0 0)) :c1cond-im16)
(defmipsinsn :bc1t    (:cri im2bd16) ((#b010001 21 #x1f) (#b01000 16 #x3) (#b01 0 0)) :c1cond-im16)
(defmipsinsn :bc1fl   (:cri im2bd16) ((#b010001 21 #x1f) (#b01000 16 #x3) (#b10 0 0)) :c1cond-im16)
(defmipsinsn :bc1fl   (:cri im2bd16) ((#b010001 21 #x1f) (#b01000 16 #x3) (#b11 0 0)) :c1cond-im16)
...
(defmipsinsn :beql    (:cri im3bd16) ((#b010100 0 0)) :testgpr-basegpr-im16off)
(defmipsinsn :beqzl   (:cri im2bd16) ((#b010100 16 #x1f) (#b00000 0 0)) :testgpr-im16off)
(defmipsinsn :bnel    (:cri im3bd16) ((#b010101 0 0)) :testgpr-basegpr-im16off)
(defmipsinsn :bnezl   (:cri im2bd16) ((#b010101 16 #x1f) (#b00000 0 0)) :testgpr-im16off)
(defmipsinsn :blezl   (:cri im2bd16) ((#b010110 16 #x1f) (#b00000 0 0)) :testgpr-im16off)
(defmipsinsn :bgtzl   (:cri im2bd16) ((#b010111 16 #x1f) (#b00000 0 0)) :testgpr-im16off)
