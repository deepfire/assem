        ...
        (:nrex ((active-set :opersz/p :rep/p :repn/p :addrsz :overseg :lock
               ...
               (:xop ((active-set :xopcode
                     ...
                     (#x0f71 ((active-set (#x00f71 #x10f71))
                              (dispatch (:rep/p :repn/p :opersz/p :window)))
...
(defiformat "2|~S,  reg8"            (rw (8 (tree :r/m))    rw (:reg8))                        (:xchg #x86 :xadd #x0fc0)) ;; XADD doesn't depend on prefix
...
(defiformat "!mmx, reg/memXXl"       ( w (:mmx)             r  (xl (tree :r/m)))               (:movd #x0f6e))
(defiformat "!reg/memXXl, mmx"       ( w (xl (tree :r/m))   r  (:mmx))                         (:movd #x0f7e))
(defiformat "!xmm, reg/memXXl"       ( w (:xmm)             r  (xl (tree :r/m)))               (:movd #x0f6e 1))
(defiformat "!reg/memXXl, xmm"       ( w (xl (tree :r/m))   r  (:xmm))                         (:movd #x0f7e 1))

(defiformat "!reg32, xmm"            ( w (32 (tree :r/))    r  (:xmm))                         (:movmskps #x0f50 :movmskpd #x0f50 1))
